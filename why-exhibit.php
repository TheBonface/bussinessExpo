...
>>>>>>> Initial commit to why-exhibit drop down menu in about us
        ...
        <div class="col-md-8">
        	...
        	<h3>EXHIBITORS 2015</h3>
        	This Include
        	<li>County Governement of Kisumu</li>
        	<li>Standard Media Group</li>
        	<li>LakeHub</li>
        	<li>Stima Sacco</li>
        	<li>PEPSI</li>
        	...
        	<li>Family Bank</li>
        	<li>Ecobank</li>
        	<li>Trident School of Medical and Health Sciences</li>
        	<li>Blueseal Drycleaners</li>
        	<li>Vunduba Terrace Kisumu</li>
        	<li>House of Funk</li>
        	<li>Golden Entertainment</li>
        	<br>
        	Expected Exhibitors
        	<br>
        	<li><a href="images/stories/EXPECTED EXHIBITORS.pdf">Download Exhibition Information</a></li>
